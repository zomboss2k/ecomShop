...
const Footer = () => {
  return (
    <div className="bg-slate-700 text-slate-200 text-sm mt-16">
      <Container>
        <div className="flex flex-col md:flex-row justiyf-between pt-16 pb-8">
          <FooterList>
          ...
          <FooterList>
            <h3 className="text-base font-bold mb-2">Costomer Service</h3>
          ...
          <div className="w-full md:w-1/3 mb:-6 md:mb-0">
            ...
            <p className="mb-2">
              ...
              seletion of phones, TVs, laptops, watches, and accessories.
            </p>
